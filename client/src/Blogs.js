                    ...
                    <Col md="5">
                      <div className="card-image">
                        <img
                          ...
                          src="https://www.incimages.com/uploaded_files/image/1024x576/westworld-2-hbo-background-1920_419617.jpg"
                        ></img>
                      </div>
                    </Col>
                    <Col md="7">
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised rounded"
                            src="https://www.theadkx.org/wp-content/uploads/2020/04/Minnow-Pond-Guideboat_ADKX_Zoom-1024x576.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised rounded"
                            src="https://www.exploregeorgia.org/sites/default/files/minnehaha-falls-rabun-county-ga-logo-benjamingalland.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised rounded"
                            src="https://www.theadkx.org/wp-content/uploads/2020/04/ADKXOverlook-summer_Zoom-1024x576.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised rounded"
                            src="https://www.theadkx.org/wp-content/uploads/2020/04/ADKXBoathouse_Zoom-1024x576.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
                    ...
                    <Col md="4">
                      <div className="card-image">
                        <img
                          alt="..."
                          className="img img-raised rounded"
                          src="https://www.theadkx.org/wp-content/uploads/2020/04/1972.160.0003_ADKX_Zoom-1024x576.jpg"
                        ></img>
                      </div>
                    </Col>
                    <Col md="8">
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised rounded"
                            src="https://www.theadkx.org/wp-content/uploads/2020/04/ADKX_Bull-Cottage_Zoom-1024x557.jpg"
                          ></img>
                        </a>
                      </div>
                    </Col>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised rounded"
                            src="https://www.theadkx.org/wp-content/uploads/2020/04/19630370002_ADKX_Zoom-1024x511.jpg"
                          ></img>
                        </a>
                      </div>
                    </Col>
                    <Col md="8">
                      ...
                      <div className="author">
                        <img
                          alt="..."
                          className="avatar img-raised"
                          src="https://i0.wp.com/www.smartertravel.com/uploads/2020/03/ST_ZoomBackground_Beach02.jpg"
                        ></img>
                  ...
                  <div className="card-image">
                    <a href="#pablo" onClick={(e) => e.preventDefault()}>
                      <img
                        alt="..."
                        className="img img-raised rounded"
                        src="https://i0.wp.com/www.smartertravel.com/uploads/2020/03/ST_ZoomBackground_Beach01.jpg"
                      ></img>
                    </a>
                  </div>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            ...
                            src="https://i0.wp.com/www.smartertravel.com/uploads/2020/03/ST_ZoomBackground_Europe03.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img rounded"
                            src="https://i2.wp.com/www.smartertravel.com/uploads/2020/03/ST_ZoomBackground_Europe02.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={(e) => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img rounded"
                            src="https://i1.wp.com/www.smartertravel.com/uploads/2020/03/ST_ZoomBackground_Europe01.jpg"
                          ></img>
                        </a>
                      </div>
                      <CardBody>
